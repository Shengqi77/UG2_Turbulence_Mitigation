...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--dataset', type=str, default ='turbu_173_multi_in_single_out_3')
        parser.add_argument('--pretrain_weights',type=str, default='logs/motiondeblur_multi_in_single_out+res+mean/text_4500_normal_multi_in_single_out_addnoise/Uformer_B_/models/model_latest.pth')
        ...
        parser.add_argument('--mode', type=str, default ='detur',  help='image restoration mode')
        ...
        parser.add_argument('--train_dir', type=str, default ='./datasets/turbu_173_multi_in_single_out_3/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./datasets/turbu_173_multi_in_single_out_3/val',  help='dir of train data')
